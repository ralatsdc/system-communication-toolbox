...
function Plot(h_start, fuselage_loss_offset, plotLabel, runLabel, ...
...
%   subtitleStr - Subtitle of the plot
  ...
  print(sprintf('simulate-esim-at-altitude-ter-es-rx-pattern-h-%s.pdf', runLabel), '-dpdf');
  pause(1); close(fH);
  ...
  PlotUtility.trim_plot(off);
  % TODO: Use -h- or -v- correctly
  print(sprintf('simulate-esim-at-altitude-ter-es-rx-pattern-v-%s.pdf', runLabel), '-dpdf');
  pause(1); close(fH);
  ...
  off = [0.05, 0.05, 0.05, 0.05];
  PlotUtility.trim_plot(off);
  print(sprintf('simulate-esim-at-altitude-leo-es-tx-pattern-%s.pdf', runLabel), '-dpdf');
  pause(1); close(fH);
  ...
  off = [0.05, 0.05, 0.05, 0.05];
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'cdf', runLabel);
  pause(1); close(fH);
  return
  ...
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'i-to-n', runLabel);
  pause(1); close(fH);
  ...
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'd-i-i', runLabel);
  pause(1); close(fH);
  ...
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'd-i-w', runLabel);
  pause(1); close(fH);
  ...
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'angles-t', runLabel);
  pause(1); close(fH);
  ...
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'angles-r', runLabel);
  pause(1); close(fH);
  ...
  PlotUtility.trim_plot(off);
  print_plot(h_start, fuselage_loss_offset, plotLabel, 'gains', runLabel);
  pause(1); close(fH);

end % Plot()

function print_plot(h_start, fuselage_loss_offset, plotLabel, identifier, runLabel)
  print(sprintf('simulate-esim-at-altitude-%d-%d-%s-%s-ie-%s.pdf', ...
                h_start, fuselage_loss_offset, plotLabel, identifier, runLabel), '-dpdf');
