...
% 
classdef PatternENST802V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern ENST802V01.
  ...
  methods
    ...
    function this = PatternENST802V01(GainMax, CoefA, CoefB, CoefC, CoefD, Phi1, Gmin)
    ...
    % No argument constructor
      ...
      if ~(nargin == 7 ...
        ...
        exc = SException( ...
            ...
            'Numeric GainMax, CoefA, CoefB, CoefC, CoefD, Phi1, and Gmin must be provided.');
        throw(exc)
    ...
    end % PatternENST802V01()
    
    function that = copy(this)
    % Copies a PatternENST802V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternENST802V01(this.GainMax, this.CoefA, this.CoefB, ...
                               this.CoefC, this.CoefD, this.Phi1, this.Gmin);
    ...
    % antenna gain (Gmin) must be provided.
    %
    % Parameters:
    ...
    % Check number and class of input arguments.
      ...
      G2 = max(min(G_phi1, this.CoefC - this.CoefD * log10(phi)), this.Gmin);
      ...
      if this.Gmin < -100 || this.Gmin > this.GainMax
        exc = SException( ...
