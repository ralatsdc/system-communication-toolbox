...
% 
classdef PatternELUX205V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern ELUX205V01.
  ...
  methods
    ...
    function this = PatternELUX205V01(GainMax, Efficiency)
    ...
    % No argument constructor
      ...
      this.d_over_lambda = sqrt((10 ^ (this.GainMax / 10)) / (Efficiency * pi ^ 2));
    ...
    % Parameters:
    %   None
      that = PatternELUX205V01(this.GainMax, this.Efficiency);
    ...
    % Check number and class of input arguments.
      ...
      G =        G0 .* (     0     <= phi & phi <  this.phi_m) ...
          ...
          +      G3 .* (     7     <= phi & phi <       9) ...
          +      G4 .* (     9     <= phi & phi <  this.phi_b) ...
          +      G5 .* (this.phi_b <= phi & phi <=      180);
