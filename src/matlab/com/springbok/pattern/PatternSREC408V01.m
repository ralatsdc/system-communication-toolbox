...
% 
classdef PatternSREC408V01 < SpacePattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern SREC408V01.
  ...
  methods
    ...
    function this = PatternSREC408V01(Phi0)
    % Constructs a PatternSREC408V01 given a maximum antenna gain.
    %
    % Parameters
    ...
    end % PatternSREC408V01()
    
    function that = copy(this)
    % Copies a PatternSREC408V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternSREC408V01(this.Phi0);

    end % copy()

    function [G, Gx, fH] = gain(this, Phi, varargin)
    % Recommendation ITU-R S.672-4 space station antenna pattern in
    % FSS for Ls = -20 dB.
    %
    % Parameters:
    ...
    % Check number and class of input arguments.
      ...
      G1 = this.GainMax + Ls;
      G2 = this.GainMax + Ls + 20 - 25 * log10(2 * phi_over_phi0);
