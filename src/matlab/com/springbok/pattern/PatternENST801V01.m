classdef PatternENST801V01 < EarthPattern & TransmitPattern & ReceivePattern
...
% Copyright (C) 2016 Springbok LLC <http://springbok.io/> All rights reserved.
  ...
  methods
    ...
    function this = PatternENST801V01(GainMax, Efficiency, CoefA)
    ...
    end % PatternENST801V01()
    
    function that = copy(this)
    % Copies a PatternENST801V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternENST801V01(this.GainMax, this.Efficiency, this.CoefA);

    end % copy()

    function [G, Gx, fH] = gain(this, Phi, varargin)
    % Non-standard OBSOLETE earth station antenna pattern similar
    % to that in Recommendation ITU-R S.465-3, where the side-lobe
    ...
    % Check number and class of input arguments.
      ...
      if this.d_over_lambda < 100
        warning( ...
            'Springbok:InvalidResult', ...
            'D/lambda is less than 100.  CoefA is ignored.');
