...
% 
classdef PatternEREC014V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern EREC014V01.
  ...
  methods
    ...
    function this = PatternEREC014V01(GainMax, Efficiency)
    ...
    % No argument constructor
      ...
      elseif 100 <= this.d_over_lambda && this.d_over_lambda <= 150
        this.G1 = 2 + 15 * log10(this.d_over_lambda);
    ...
    end % PatternEREC014V01()
    
    function that = copy(this)
    % Copies a PatternEREC014V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternEREC014V01(this.GainMax, this.Efficiency);

    end % copy()

    function [G, Gx, fH] = gain(this, Phi, varargin)
    % Recommendation ITU-R S.580-5 reference Earth station antenna
    % pattern for antennas installed BEFORE 1995.
    %
    % Parameters:
    ...
    % Check number and class of input arguments.
      ...
      elseif 50 <= this.d_over_lambda && this.d_over_lambda <= 150
        G2 = 32 - 25 * log10(phi);
        G3 = -10;
