classdef PatternSRR_406V01Test < TestUtility
...
% Copyright (C) 2016 Springbok LLC <http://springbok.io/> All rights reserved.
  ...
  methods
    ...
    function this = PatternSRR_406V01Test(logFId, testMode)
    % Constructs a PatternSRR_406V01Test
    %
    % Parameters:
    ...
    end % PatternSRR_406V01Test()
    
    function test_PatternSRR_406V01(this)
    % Tests PatternSRR_406V01 method.
      
      p = PatternSRR_406V01(this.Beamlet_input, this.Phi0_input);
