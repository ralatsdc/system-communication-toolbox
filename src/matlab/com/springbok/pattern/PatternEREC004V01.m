...
% 
classdef PatternEREC004V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern EREC004V01.
  ...
  methods
    ...
    function this = PatternEREC004V01(GainMax, Efficiency)
    ...
    end % PatternEREC004V01()
    
    function that = copy(this)
    % Copies a PatternEREC004V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternEREC004V01(this.GainMax, this.Efficiency);

    end % copy()

    function [G, Gx, fH] = gain(this, Phi, varargin)
    % Recommendation ITU-R S.580-2 OBSOLETE reference Earth station
    % antenna pattern for antennas installed before 1995.
    %
    % Parameters:
    ...
    % Check number and class of input arguments.
      ...
      elseif 50 <= this.d_over_lambda && this.d_over_lambda <= 100
        G2 = 32 - 25 * log10(phi);
        G3 = 52 - 10 * log10(this.d_over_lambda) - 25 * log10(phi);
        G4 = 10 - 10 * log10(this.d_over_lambda);
