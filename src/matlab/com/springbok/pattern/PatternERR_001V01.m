...
% 
classdef PatternERR_001V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern ERR_001V01.
  ...
  methods
    ...
    function this = PatternERR_001V01(GainMax)
    ...
    end % PatternERR_001V01()
    
    function that = copy(this)
    % Copies a PatternERR_001V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternERR_001V01(this.GainMax);
      
    end % copy()

    function [G, Gx, fH] = gain(this, Phi, varargin)
    % Appendix 8 (RR-2001) Earth station antenna pattern. (Former
    % Appendix 28 and Appendix 29 antenna pattern.)
    %
    % Parameters:
