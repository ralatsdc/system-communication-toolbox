classdef PatternSRR_404V01Test < TestUtility
...
% Copyright (C) 2016 Springbok LLC <http://springbok.io/> All rights reserved.
  ...
  methods
    ...
    function this = PatternSRR_404V01Test(logFId, testMode)
    % Constructs a PatternSRR_404V01Test
    %
    % Parameters:
    ...
    end % PatternSRR_404V01Test()
    
    function test_PatternSRR_404V01(this)
    % Tests PatternSRR_404V01 method.
      
      p = PatternSRR_404V01(this.Phi0_input);
