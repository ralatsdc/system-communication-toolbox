...
% 
classdef PatternSRR_403V01 < SpacePattern & ReceivePattern
% Describes the ITU antenna pattern SRR_403V01.
  ...
  methods
    ...
    function this = PatternSRR_403V01(Phi0)
    ...
    % Parameters
    %   None
      that = PatternSRR_403V01(this.Phi0);
    ...
    % Check number and class of input arguments.
      ...
      Gx0 = this.GainMax - 30 - 12 * phi_over_phi0 .^ 2;
      Gx1 = this.GainMax - 33;
      
      phix = max(eps, phi_over_phi0 - 1);
      Gx2 = this.GainMax - 40 - 40 * log10(phix);
      
      Gx = Gx0 .* (0    <= phi_over_phi0 & phi_over_phi0 <=  0.5) ...
           + Gx1 .* (0.5  <  phi_over_phi0 & phi_over_phi0 <= 1.67) ...
