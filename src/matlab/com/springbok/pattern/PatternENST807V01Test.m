classdef PatternENST807V01Test < TestUtility
% Tests methods of PatternENST807V01 class.
...
% Copyright (C) 2016 Springbok LLC <http://springbok.io/> All rights reserved.
  ...
  methods
    ...
    function this = PatternENST807V01Test(logFId, testMode)
    % Constructs a PatternENST807V01Test
    %
    % Parameters:
    ...
    end % PatternENST807V01Test()
    
    function test_PatternENST807V01(this)
    % Tests PatternENST807V01 method.
      
      p_1 = PatternENST807V01(this.GainMax_input_1, ...
                              this.CoefA_input_1, this.CoefB_input_1, this.CoefC_input_1, this.CoefD_input_1, ...
                              this.Phi1_input_1);
      
      this.assert_true( ...
          'PatternENST807V01', ...
          sprintf('PatternENST807V01:%.1f', this.GainMax_input_1), ...
          this.HIGH_PRECISION_DESC, ...
          PatternUtility.compare_pattern(this.self_1, p_1));
      
      p_2 = PatternENST807V01(this.GainMax_input_2, ...
                              this.CoefA_input_2, this.CoefB_input_2, this.CoefC_input_2, this.CoefD_input_2, ...
                              this.Phi1_input_2);
      
      this.assert_true( ...
          'PatternENST807V01', ...
          sprintf('PatternENST807V01:%.1f', this.GainMax_input_2), ...
          this.HIGH_PRECISION_DESC, ...
          PatternUtility.compare_pattern(this.self_2, p_2));
      
    end % test_PatternENST807V01()
