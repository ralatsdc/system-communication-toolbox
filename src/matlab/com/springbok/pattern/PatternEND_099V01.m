...
% 
classdef PatternEND_099V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern END_099V01.
  ...
  methods
    ...
    function this = PatternEND_099V01(GainMax)
    ...
    end % PatternEND_099V01()
    
    function that = copy(this)
    % Copies a PatternEND_099V01 given a maximum antenna gain.
    %
    %
    % Parameters:
    %   None
      that = PatternEND_099V01(this.GainMax);
