classdef PatternSREC407V01 < SpacePattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern SREC407V01.
...
% Copyright (C) 2016 Springbok LLC <http://springbok.io/> All rights reserved.
  ...
  methods
    ...
    function this = PatternSREC407V01(Phi0)
    % Constructs a PatternSREC407V01 given a maximum antenna gain.
    %
    % Parameters
    ...
    end % PatternSREC407V01()
    
    function that = copy(this)
    % Copies a PatternSREC407V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternSREC407V01(this.Phi0);
