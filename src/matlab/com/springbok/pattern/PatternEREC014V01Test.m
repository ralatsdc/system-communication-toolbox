...
% 
classdef PatternEREC014V01Test < TestUtility
% Tests methods of PatternEREC014V01 class.
  ...
  properties (Constant = true)
    ...
    self_2 = struct( ...
        'GainMax', 44, ...
        'Efficiency', 0.7, ...
        'phi_m', 1.387249209510213, ...
        'phi_r', 1.658436672839821, ...
        'phi_b', 47.863009232263828, ...
        'd_over_lambda', 60.297750066491929, ...
        'G1', 26.507527682468449);
    
    Phi_input = [0.2; 0.6; 1.5; 10; 22; 150];
  ...
  methods
    ...
    function this = PatternEREC014V01Test(logFId, testMode)
    % Constructs a PatternEREC014V01Test
    %
    % Parameters:
    ...
    end % PatternEREC014V01Test()
    
    function test_PatternEREC014V01(this)
    % Tests PatternEREC014V01 method.
      
      p_1 = PatternEREC014V01(this.GainMax_input_1, this.Efficiency_input);
      
      this.assert_true( ...
          'PatternEREC014V01', ...
          sprintf('PatternEREC014V01:%.1f', this.GainMax_input_1), ...
          this.HIGH_PRECISION_DESC, ...
          PatternUtility.compare_pattern(this.self_1, p_1));
      
      p_2 = PatternEREC014V01(this.GainMax_input_2, this.Efficiency_input);
      
      this.assert_true( ...
          'PatternEREC014V01', ...
          sprintf('PatternEREC014V01:%.1f', this.GainMax_input_2), ...
          this.HIGH_PRECISION_DESC, ...
          PatternUtility.compare_pattern(this.self_2, p_2));
      
    end % test_PatternEREC014V01()
