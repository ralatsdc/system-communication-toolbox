...
% 
classdef PatternEREC003V01 < EarthPattern & TransmitPattern & ReceivePattern
% Describes the ITU antenna pattern EREC003V01.
  ...
  methods
    ...
    function this = PatternEREC003V01(GainMax, Efficiency)
    ...
    end % PatternEREC003V01()
    
    function that = copy(this)
    % Copies a PatternEREC003V01 given a maximum antenna gain.
    %
    % Parameters
    %   None
      that = PatternEREC003V01(this.GainMax, this.Efficiency);

    end % copy()

    function [G, Gx, fH] = gain(this, Phi, varargin)
    % Recommendation ITU-R S.465-3 OBSOLETE reference Earth station
    % antenna pattern.
    %
    % Parameters:
