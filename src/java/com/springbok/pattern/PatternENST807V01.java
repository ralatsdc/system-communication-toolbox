 ...
 */
public class PatternENST807V01 implements EarthPattern, TransmitPattern, ReceivePattern {
     ...
     * @param CoefA   Near sidelobe reference level [dB]
     * @param CoefB   Near sidelobe roll-off level [dB]
     * @param CoefC   Far sidelobe reference level [dB]
     * @param CoefD   Far sidelobe roll-off level [dB]
     * @param Phi1    Angular extent of near sidelobe [degrees]
     */
    public PatternENST807V01(double GainMax, double CoefA, double CoefB, double CoefC, double CoefD, double Phi1) {
    ...
    /**
     * Gets near sidelobe reference level [dB].
     *
     ...
     */
    public PatternENST807V01 copy() {
        return new PatternENST807V01(this.GainMax, this.CoefA, this.CoefB, this.CoefC, this.CoefD, this.Phi1);
    }

    /**
     * Non-standard generic earth station antenna pattern described by 4 main
     * coefficients: A, B, C, D and angle phi1. Minimum antenna gain (Gmin) is -10
     * dB.
     *
    ...
    public Gain gain(double Phi, Map options) {
        ...
        double G2 = Math.max(Math.min(G_phi1, CoefC - CoefD * Math.log10(phi)), -10);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PatternENST807V01)) {
            return false;
        }
        PatternENST807V01 other = (PatternENST807V01) obj;
