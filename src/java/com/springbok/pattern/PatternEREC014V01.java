...
/**
 * Describes the ITU antenna pattern EREC014V01.
 */
public class PatternEREC014V01 implements EarthPattern, TransmitPattern, ReceivePattern {
	...
	/**
	 * Constructs a PatternEREC014V01 given a maximum antenna gain.
	 *
	 * @param GainMax
	 *            Maximum antenna gain [dB]
	 * @param Efficiency
	 *            Antenna efficiency, fraction
	 */
	public PatternEREC014V01(double GainMax, double Efficiency) {
		...
		if (this.d_over_lambda < 50) {
			...
			this.G1 = -18 + 25 * Math.log10(this.d_over_lambda);
		} else if (100 <= this.d_over_lambda && this.d_over_lambda <= 150) {
			this.G1 = 2 + 15 * Math.log10(this.d_over_lambda);
		} else { // 150 < this.d_over_lambda
	 ...
	 */
	public PatternEREC014V01 copy() {
		return new PatternEREC014V01(this.GainMax, this.Efficiency);
	}

	/**
	 * Recommendation ITU-R S.580-5 reference Earth station antenna pattern for
	 * antennas installed BEFORE 1995.
	 *
	 * @param Phi
	...
	public Gain gain(double Phi, Map options) {
		...
		} else if (50 <= d_over_lambda && d_over_lambda <= 150) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PatternEREC014V01)) {
			return false;
		}
		PatternEREC014V01 other = (PatternEREC014V01) obj;
