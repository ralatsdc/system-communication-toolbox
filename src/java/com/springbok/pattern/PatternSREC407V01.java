 ...
 *
 */
public class PatternSREC407V01 implements EarthPattern {
	...
	public PatternSREC407V01(double GainMax, double Phi0) {
	...
	public EarthPattern copy() {
		return new PatternSREC407V01(GainMax, Phi0);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PatternSREC407V01)) {
			return false;
		}
		PatternSREC407V01 other = (PatternSREC407V01) obj;
