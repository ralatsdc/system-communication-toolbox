 ...
 */
public class PatternEREC013V01 implements EarthPattern, TransmitPattern, ReceivePattern {
	 ...
	 *            Antenna efficiency, fraction
	 */
	public PatternEREC013V01(double GainMax, double Efficiency) {
	 ...
	 */
	public PatternEREC013V01 copy() {
		return new PatternEREC013V01(this.GainMax, this.Efficiency);
	}

	/**
	 * Recommendation ITU-R S.465-5 reference Earth station antenna pattern for
	 * earth stations coordinated after 1993.
	 * 
	 * @param Phi
	...
	public Gain gain(double Phi, Map options) {
		...
		double G2 = 32 - 25 * Math.log10(phi);
		double G3 = -10;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PatternEREC013V01)) {
			return false;
		}
		PatternEREC013V01 other = (PatternEREC013V01) obj;
