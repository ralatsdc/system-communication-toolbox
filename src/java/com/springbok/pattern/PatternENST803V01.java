 ...
 */
public class PatternENST803V01 implements EarthPattern, TransmitPattern, ReceivePattern {
     ...
     */
    public PatternENST803V01(double GainMax, double Efficiency, double CoefA) {
     ...
     */
    public PatternENST803V01 copy() {
        return new PatternENST803V01(this.GainMax, this.Efficiency, this.CoefA);
    }

    /**
     * Non-standard generic earth station antenna pattern similar to that in
     * Appendix 30B (RR-2001), where the side-lobe radiation is represented by the
     * expression CoefA - 25 log(phi).
     *
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PatternENST803V01)) {
            return false;
        }
        PatternENST803V01 other = (PatternENST803V01) obj;
