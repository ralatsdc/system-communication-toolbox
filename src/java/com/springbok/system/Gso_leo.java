...
public class Gso_leo {
    public static System[] getSystems() {
        ...
        System wantedSystem = new System(new ArrayList<EarthStation>(Arrays.asList(wantedEarthStation)), new ArrayList<SpaceStation>(Arrays.asList(wantedSpaceStation)),
                losses, epoch_0, options);

        //Define the interfering system

        ArrayList<SpaceStation> interferingSpaceStations = Gso_gso.getIntLeoSpaceSegment(epoch_0);
        ArrayList<EarthStation> interferingEarthStations = Gso_gso.getIntLeoEarthSegment(wantedSpaceStation);
