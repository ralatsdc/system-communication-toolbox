...
public class Sgp4Unit implements Serializable {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Vector<Sgp4Data> results = sgp4.runSgp4(card1, card2, startYr, startDay, stopYr, stopDay, step);
			for (int i = 0; i < results.size(); i++) {
				data = (Sgp4Data) results.elementAt(i);

				System.out.println("x " + data.getX() * radiusearthkm + " y " + data.getY() * radiusearthkm + " z "
						+ data.getZ() * radiusearthkm + " vx " + data.getXdot() * vkmpersec + " vy "
						+ data.getYdot() * vkmpersec + " vz " + data.getZdot() * vkmpersec);
			}
	 ...
	 *
	 ----------------------------------------------------------------------------*/
	private void dpper(double e3, double ee2, double peo, double pgho, double pho, double pinco, double plo, double se2,
			double se3, double sgh2, double sgh3, double sgh4, double sh2, double sh3, double si2, double si3,
			double sl2, double sl3, double sl4, double t, double xgh2, double xgh3, double xgh4, double xh2, double xh3,
			double xi2, double xi3, double xl2, double xl3, double xl4, double zmol, double zmos, int init) {
		...
		// if (dbgfile != NULL)
		{
			...
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "e3", e3, "ee2", ee2, "peo",
					peo, "pgho", pgho, "pho", pho, "pinco", pinco);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "plo", plo, "se2", se2, "se3",
					se3, "sgh2", sgh2, "sgh3", sgh3, "sgh4", sgh4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sh2", sh2, "sh3", sh3, "si2",
					si2, "si3", si3, "sl2", sl2, "sl3", sl3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sl4", sl4, "t", t, "xgh2",
					xgh2, "xgh3", xgh3, "xgh4", xgh4, "xh2", xh2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xh3", xh3, "xi2", xi2, "xi3",
					xi3, "xl2", xl2, "xl3", xl3, "xl4", xl4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15d\n", "zmol", zmol, "zmos", zmos, "init", init);
			System.out.printf("    in/out : \n");
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "ep", satrec.ep, "inclp", satrec.xincp,
					"omegap", satrec.omegap, "argpp", satrec.argpp, "mp", satrec.mp);
		}
	}
	...
	private void dscom(double epoch, double ep, double argpp, double tc, double inclp, double omegap, double np) {
		...
		// if (dbgfile != NULL)
		{
			...
			System.out.printf("    inputs :\n");
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "epoch ", epoch, "ep", ep,
					"argpp", argpp, "tc", tc, "inclp", inclp, "omegap", omegap);
			System.out.printf("%7s%15.9f\n", "np", np);
			System.out.printf("    outputs :\n");
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "snodm", snodm, "cnodm",
					cnodm, "sinim", sinim, "cosim", cosim, "sinomm", sinomm, "cosomm", cosomm);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "day", day, "e3",
					satrec.dsvalues.e3, "ee2", satrec.dsvalues.ee2, "em", em, "emsq", emsq, "gam", gam);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "peo", satrec.dsvalues.peo, "pgho",
					satrec.dsvalues.pgho, "pho", satrec.dsvalues.pho, "pinco", satrec.dsvalues.pinco, "plo",
					satrec.dsvalues.plo);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "rtemsq", rtemsq, "se2",
					satrec.dsvalues.se2, "se3", satrec.dsvalues.se3, "sgh2", satrec.dsvalues.sgh2, "sgh3",
					satrec.dsvalues.sgh3, "sgh4", satrec.dsvalues.sgh4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sh2", satrec.dsvalues.sh2,
					"sh3", satrec.dsvalues.sh3, "si2", satrec.dsvalues.si2, "si3", satrec.dsvalues.si3, "sl2",
					satrec.dsvalues.sl2, "sl3", satrec.dsvalues.sl3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sl4", satrec.dsvalues.sl4,
					"s1", s1, "s2", s2, "s3", s3, "s4", s4, "s5", s5);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "s6", s6, "s7", s7, "ss1",
					ss1, "ss2", ss2, "ss3", ss3, "ss4", ss4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "ss5", ss5, "ss6", ss6, "ss7",
					ss7, "sz1", sz1, "sz2", sz2, "sz3", sz3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sz11", sz11, "sz12", sz12,
					"sz13", sz13, "sz21", sz21, "sz22", sz22, "sz23", sz23);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sz31", sz31, "sz32", sz32,
					"sz33", sz33, "xgh2", satrec.dsvalues.xgh2, "xgh3", satrec.dsvalues.xgh3, "xgh4",
					satrec.dsvalues.xgh4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xh2", satrec.dsvalues.xh2,
					"xh3", satrec.dsvalues.xh3, "xi2", satrec.dsvalues.xi2, "xi3", satrec.dsvalues.xi3, "xl2",
					satrec.dsvalues.xl2, "xl3", satrec.dsvalues.xl3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xl4", satrec.dsvalues.xl4,
					"nm", nm, "z1", z1, "z2", z2, "z3", z3, "z11", z11);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "z12", z12, "z13", z13, "z21",
					z21, "z22", z22, "z23", z23, "z31", z31);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "z32", z32, "z33", z33, "zmol",
					satrec.dsvalues.zmol, "zmos", satrec.dsvalues.zmos);
		}
	}
	 ...
	 *
	 ----------------------------------------------------------------------------*/
	private void dsinit(double cosim, double emsq, double argpo, double s1, double s2, double s3, double s4, double s5,
			double sinim, double t, double tc, double gsto, double mo, double mdot, double no, double omegao,
			double omegadot, double xpidot, double z1, double z3, double z11, double z13, double z21, double z23,
			double z31, double z33, double ecco, double eccsq) {

		/* --------------------- local variables ------------------------ */

		double ainv2, aonv = 0.0, cosisq, eoc, f220, f221, f311, f321, f322, f330, f441, f442, f522, f523, f542, f543,
				g200, g201, g211, g300, g310, g322, g410, g422, g520, g521, g532, g533, ses, sgs, sghl, sghs, shs, shll,
				sis, sini2, sls, temp, temp1, theta, xno2, q22, q31, q33, root22, root44, root54, rptim, root32, root52,
				x2o3, xke, znl, emo, zns, emsqo;
		...
		if (satrec.dsvalues.irez == 1) {
			...
			satrec.dsvalues.xfact = mdot + xpidot - rptim + satrec.dsvalues.dmdt + satrec.dsvalues.domdt
		...
		// if (dbgfile != NULL)
		{
			...
			System.out.printf("%84s\n", " ------------------after dsinit---------------");
			System.out.printf(" inputs :\n");
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "cosim", cosim, "emsq", emsq,
					"argpo", argpo, "s1", s1, "s2", s2, "s3", s3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "s4", s4, "s5", s5, "sinim",
					sinim, "ss1", ss1, "ss2", ss2, "ss3", ss3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "ss4", ss4, "ss5", ss5, "sz1",
					sz1, "sz3", sz3, "sz11", sz11, "sz13", sz13);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sz21", sz21, "sz23", sz23,
					"sz31", sz31, "sz33", sz33, "t", t, "tc", tc);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "gsto", gsto, "mo", mo,
					"mdot", mdot, "no", no, "omegao", omegao, "omegadt", omegadot);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xpidot", xpidot, "z1", z1,
					"z3", z3, "z11", z11, "z13", z13, "z21", z21);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f\n", "z23", z23, "z31", z31, "z33", z33);
			System.out.printf(" in /out :\n");
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "em", em, "argpm", argpm,
					"inclm", inclm, "mm", mm, "nm", nm, "omegam", omegam);
			System.out.printf(" outputs :\n");
			System.out.printf("%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "irez", satrec.dsvalues.irez,
					"atime", satrec.dsvalues.atime, "d2201", satrec.dsvalues.d2201, "d2211", satrec.dsvalues.d2211,
					"d3210", satrec.dsvalues.d3210, "d3222", satrec.dsvalues.d3222);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "d4410",
					satrec.dsvalues.d4410, "d4422", satrec.dsvalues.d4422, "d5220", satrec.dsvalues.d5220, "d5232",
					satrec.dsvalues.d5232, "d5421", satrec.dsvalues.d5421, "d5433", satrec.dsvalues.d5433);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "dedt", satrec.dsvalues.dedt,
					"didt", satrec.dsvalues.didt, "dmdt", satrec.dsvalues.dmdt, "dndt", dndt, "dnodt",
					satrec.dsvalues.dnodt, "domdt", satrec.dsvalues.domdt);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "del1", satrec.dsvalues.del1,
					"del2", satrec.dsvalues.del2, "del3", satrec.dsvalues.del3, "xfact", satrec.dsvalues.xfact, "xlamo",
					satrec.dsvalues.xlamo, "xli", satrec.dsvalues.xli);
	 ...
	 *
	 ----------------------------------------------------------------------------*/
	private void dspace(int irez, double d2201, double d2211, double d3210, double d3222, double d4410, double d4422,
		...
		int iretn, iret;
		double delt, ft = 0.0, theta, x2li, x2omi, xl, xldot = 0.0, xnddt = 0.0, xndt = 0.0, xomi, g22, g32, g44, g52,
				g54, fasx2, fasx4, fasx6, rptim, step2, stepn, stepp;
		...
		satrec.dsvalues.atime = 0.0;
		if (irez != 0) {
			if ((satrec.dsvalues.atime == 0.0) || ((t >= 0.0) && (satrec.dsvalues.atime < 0.0))
			...
			while (iretn == 381) {
				...
				if (irez != 2) {
					xndt = del1 * Math.sin(satrec.dsvalues.xli - fasx2)
							+ del2 * Math.sin(2.0 * (satrec.dsvalues.xli - fasx4))
							+ del3 * Math.sin(3.0 * (satrec.dsvalues.xli - fasx6));
					xldot = satrec.dsvalues.xni + xfact;
					xnddt = del1 * Math.cos(satrec.dsvalues.xli - fasx2)
							+ 2.0 * del2 * Math.cos(2.0 * (satrec.dsvalues.xli - fasx4))
							+ 3.0 * del3 * Math.cos(3.0 * (satrec.dsvalues.xli - fasx6));
					xnddt = xnddt * xldot;
				} else {
					...
					xndt = d2201 * Math.sin(x2omi + satrec.dsvalues.xli - g22)
							...
							+ d3210 * Math.sin(xomi + satrec.dsvalues.xli - g32)
							+ d3222 * Math.sin(-xomi + satrec.dsvalues.xli - g32) + d4410 * Math.sin(x2omi + x2li - g44)
							+ d4422 * Math.sin(x2li - g44) + d5220 * Math.sin(xomi + satrec.dsvalues.xli - g52)
							+ d5232 * Math.sin(-xomi + satrec.dsvalues.xli - g52) + d5421 * Math.sin(xomi + x2li - g54)
							+ d5433 * Math.sin(-xomi + x2li - g54);
					xldot = satrec.dsvalues.xni + xfact;
					xnddt = d2201 * Math.cos(x2omi + satrec.dsvalues.xli - g22)
							+ d2211 * Math.cos(satrec.dsvalues.xli - g22)
							+ d3210 * Math.cos(xomi + satrec.dsvalues.xli - g32)
							+ d3222 * Math.cos(-xomi + satrec.dsvalues.xli - g32)
							+ d5220 * Math.cos(xomi + satrec.dsvalues.xli - g52)
							+ d5232 * Math.cos(-xomi + satrec.dsvalues.xli - g52)
							+ 2.0 * (d4410 * Math.cos(x2omi + x2li - g44) + d4422 * Math.cos(x2li - g44)
									+ d5421 * Math.cos(xomi + x2li - g54) + d5433 * Math.cos(-xomi + x2li - g54));
					xnddt = xnddt * xldot;
				}
		...
		if (help == 'y') {
			...
			System.out.printf("%84s\n", " ------------------after dspace--------------- ");
			System.out.printf(" inputs : \n");
			System.out.printf("%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "irez", irez, "d2201", d2201,
					"d2211", d2211, "d3210", d3210, "d3222", d3222, "d4410", d4410);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "d4422", d4422, "d5220",
					d5220, "d5232", d5232, "d5421", d5421, "d5433", d5433, "dedt", dedt);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "del1", del1, "del2", del2,
					"del3", del3, "didt", didt, "dmdt", dmdt, "dnodt", dnodt);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "domdt", domdt, "argpo",
					argpo, "argpdot", argpdot, "t", t, "tc", tc, "gsto", gsto);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f\n", "xfact", xfact, "xlamo", xlamo, "no", no);
			System.out.printf(" in / out : \n");
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "atime",
					satrec.dsvalues.atime, "em", em, "argpm", argpm, "inclm", inclm, "xli", satrec.dsvalues.xli, "mm",
					mm);
			System.out.printf("%7s%15.9f%7s%15.9f\n", "xni", satrec.dsvalues.xni, "omegam", omegam);
			System.out.printf(" outputs : \n");
			System.out.printf("%7s%15.9f%7s%15.9f\n", "dndt", dndt, "nm", nm);
	 ...
	 * @param card2
	 */
	public void init(String card1, String card2) throws SatElsetException, ObjectDecayed {
	...
	private void initl(int satn, double ecco, double epoch, double inclo) throws ObjectDecayed {
		...
		if (help == 'y') {
			System.out.printf(" ------------------after initl  :---------------");
			System.out.printf("    inputs : \n");
			System.out.printf("satn " + satn + " yr ecco " + ecco + " epoch " + epoch + " inclo " + inclo);
			System.out.printf("    in/out : \n");
			System.out.printf("no " + satrec.no);
			System.out.printf("\n    outputs : \n");
			System.out.printf("method " + satrec.nevalues.method + " ainv " + ainv + " ao " + ao + " con41 "
					+ satrec.nevalues.con41 + " con42 " + con42 + " cosio " + cosio + "\n");
			System.out.printf("%7s%15.9f\n", "cosio2", cosio2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "einv", einv, "eccsq", eccsq,
					"omeosq", omeosq, "posq", posq, "rp", rp, "rteosq", rteosq);
			System.out.printf("%7s%15.9f%7s%15.9f\n", "sinio", sinio, "gsto", satrec.dsvalues.gsto);
		}
	}
	...
	private double julianday(int year, int mon, int inday, int hr, int min, double sec) {
		double jd = 367.0 * year - (int) ((7 * (year + (int) ((mon + 9) / 12))) * 0.25) + (int) (275 * mon / 9) + inday
				+ 1721013.5 + ((sec / 60.0 + min) / 60.0 + hr) / 24.0; // ut in
																		// days
	 ...
	 */
	public Vector<Sgp4Data> runSgp4(String card1, String card2, int startYear, double startDay, int stopYear,
			double stopDay, double step) throws SatElsetException, ObjectDecayed {
	...
	public Sgp4Data sgp4() throws ObjectDecayed {
		...
		if (satrec.nevalues.isimp != 1) {
			...
			delm = satrec.nevalues.xmcof
					* (Math.pow((1.0 + satrec.nevalues.eta * Math.cos(xmdf)), 3) - satrec.nevalues.delmo);
			temp = delomg + delm;
			mm = xmdf + temp;
			argpm = argpdf - temp;
			...
			templ = templ + satrec.nevalues.t3cof * t3
					+ t4 * (satrec.nevalues.t4cof + satrec.nevalues.t * satrec.nevalues.t5cof);
		}
		...
		if (satrec.nevalues.method == 2) {
			...
			dspace(satrec.dsvalues.irez, satrec.dsvalues.d2201, satrec.dsvalues.d2211, satrec.dsvalues.d3210,
					satrec.dsvalues.d3222, satrec.dsvalues.d4410, satrec.dsvalues.d4422, satrec.dsvalues.d5220,
					satrec.dsvalues.d5232, satrec.dsvalues.d5421, satrec.dsvalues.d5433, satrec.dsvalues.dedt,
					satrec.dsvalues.del1, satrec.dsvalues.del2, satrec.dsvalues.del3, satrec.dsvalues.didt,
					satrec.dsvalues.dmdt, satrec.dsvalues.dnodt, satrec.dsvalues.domdt, satrec.argpo,
					satrec.nevalues.argpdot, satrec.nevalues.t, tc, satrec.dsvalues.gsto, satrec.dsvalues.xfact,
		...
		// GPUFIX: removed "|| (am < 0.95)"
		// if ((em >= 1.0) || (em < -0.001) || (am < 0.95))
		if ((em >= 1.0) || (em < -0.001)) {
			satrec.error = 1;
			// System.out.println("ERROR eccentricity out of bounds"+
			// " [em: " + em+"] [am: "+am+"]");
			throw new ObjectDecayed(
					"Sgp4Unit.sgp4 ERROR eccentricity out of bounds" + " [em: " + em + "] [am: " + am + "]");
		}

		// If it is less than zero, try and correct by making eccentricity a
		// small value
		// GPUFIX: Used "1.0e-6" rather than "0.0"
		// if (em < 0.0)
		if (em < 1.0e-6)
			em = 1.0e-6;
		...
		if (satrec.nevalues.method == 2) {
			...
			dpper(satrec.dsvalues.e3, satrec.dsvalues.ee2, satrec.dsvalues.peo, satrec.dsvalues.pgho,
					satrec.dsvalues.pho, satrec.dsvalues.pinco, satrec.dsvalues.plo, satrec.dsvalues.se2,
					satrec.dsvalues.se3, satrec.dsvalues.sgh2, satrec.dsvalues.sgh3, satrec.dsvalues.sgh4,
					satrec.dsvalues.sh2, satrec.dsvalues.sh3, satrec.dsvalues.si2, satrec.dsvalues.si3,
					satrec.dsvalues.sl2, satrec.dsvalues.sl3, satrec.dsvalues.sl4, satrec.nevalues.t,
					satrec.dsvalues.xgh2, satrec.dsvalues.xgh3, satrec.dsvalues.xgh4, satrec.dsvalues.xh2,
					satrec.dsvalues.xh3, satrec.dsvalues.xi2, satrec.dsvalues.xi3, satrec.dsvalues.xl2,
					satrec.dsvalues.xl3, satrec.dsvalues.xl4, satrec.dsvalues.zmol, satrec.dsvalues.zmos, 0);
		...
		if (help == 'y') {
			System.out.printf("%84s\n", "------------------after sgp4   :---------------");
			System.out.printf("    inputs : \n");
			System.out.printf("%7s%15d%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "isimp", satrec.nevalues.isimp,
					"method", satrec.nevalues.method, "aycof", satrec.nevalues.aycof, "bstar", satrec.bstar, "con41",
					satrec.nevalues.con41, "cc1", satrec.nevalues.cc1);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "cc4", satrec.nevalues.cc4,
					"cc5", satrec.nevalues.cc5, "d2", satrec.nevalues.d2, "d3", satrec.nevalues.d3, "d4",
					satrec.nevalues.d4, "delmo", satrec.nevalues.delmo);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "ecco", satrec.ecco, "eta",
					satrec.nevalues.eta, "argpo", satrec.argpo, "argpdot", satrec.nevalues.argpdot, "omgcof",
					satrec.nevalues.omgcof, "sinmao", satrec.nevalues.sinmao);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "t", satrec.nevalues.t,
					"t2cof", satrec.nevalues.t2cof, "t3cof", satrec.nevalues.t3cof, "t4cof", satrec.nevalues.t4cof,
					"t5cof", satrec.nevalues.t5cof, "x1mth2", satrec.nevalues.x1mth2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "x7thm1",
					satrec.nevalues.x7thm1, "inclo", satrec.inclo, "mo", satrec.mo, "mdot", satrec.nevalues.mdot, "xno",
					satrec.no, "omegao", satrec.omegao);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "omegadt", satrec.nevalues.omegadot, "xlcof",
					satrec.nevalues.xlcof, "xmcof", satrec.nevalues.xmcof, "omegacf", satrec.nevalues.omegacf);
			System.out.printf("    outputs : \n");
			System.out.printf("%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "error", satrec.error,
					"x", satrec.r[0], "y", satrec.r[1], "z", satrec.r[2], "xdot", satrec.v[0], "ydot", satrec.v[1],
					"zdot", satrec.v[2]);
			...
			System.out.printf("%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "irez", satrec.dsvalues.irez, "d2201",
					satrec.dsvalues.d2201, "d2211", satrec.dsvalues.d2211, "d3210", satrec.dsvalues.d3210, "d3222",
					satrec.dsvalues.d3222);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "d4410",
					satrec.dsvalues.d4410, "d4422", satrec.dsvalues.d4422, "d5220", satrec.dsvalues.d5220, "d5232",
					satrec.dsvalues.d5232, "d5421", satrec.dsvalues.d5421, "d5433", satrec.dsvalues.d5433);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "dedt", satrec.dsvalues.dedt,
					"del1", satrec.dsvalues.del1, "del2", satrec.dsvalues.del2, "del3", satrec.dsvalues.del3, "didt",
					satrec.dsvalues.didt, "dmdt", satrec.dsvalues.dmdt);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "dnodt",
					satrec.dsvalues.dnodt, "domdt", satrec.dsvalues.domdt, "e3", satrec.dsvalues.e3, "ee2",
					satrec.dsvalues.ee2, "peo", satrec.dsvalues.peo, "pgho", satrec.dsvalues.pgho);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "pho", satrec.dsvalues.pho,
					"pinco", satrec.dsvalues.pinco, "plo", satrec.dsvalues.plo, "se2", satrec.dsvalues.se2, "se3",
					satrec.dsvalues.se3, "sgh2", satrec.dsvalues.sgh2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sgh3", satrec.dsvalues.sgh3,
					"sgh4", satrec.dsvalues.sgh4, "sh2", satrec.dsvalues.sh2, "sh3", satrec.dsvalues.sh3, "si2",
					satrec.dsvalues.si2, "si3", satrec.dsvalues.si3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sl2", satrec.dsvalues.sl2,
					"sl3", satrec.dsvalues.sl3, "sl4", satrec.dsvalues.sl4, "gsto", satrec.dsvalues.gsto, "xfact",
					satrec.dsvalues.xfact, "xgh2", satrec.dsvalues.xgh2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xgh3", satrec.dsvalues.xgh3,
					"xgh4", satrec.dsvalues.xgh4, "xh2", satrec.dsvalues.xh2, "xh3", satrec.dsvalues.xh3, "xi2",
					satrec.dsvalues.xi2, "xi3", satrec.dsvalues.xi3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xl2", satrec.dsvalues.xl2,
					"xl3", satrec.dsvalues.xl3, "xl4", satrec.dsvalues.xl4, "xlamo", satrec.dsvalues.xlamo, "zmol",
					satrec.dsvalues.zmol, "zmos", satrec.dsvalues.zmos);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f\n", "atime", satrec.dsvalues.atime, "xli",
					satrec.dsvalues.xli, "xni", satrec.dsvalues.xni);
		}
	...
	private void sgp4init(int satn, int year, double epoch) throws ObjectDecayed {
		...
		if ((omeosq >= 0.0) || (satrec.no >= 0.0)) {
			...
			cc2 = coef1 * satrec.no * (ao * (1.0 + 1.5 * etasq + eeta * (4.0 + etasq))
					+ 0.375 * j2 * tsi / psisq * satrec.nevalues.con41 * (8.0 + 3.0 * etasq * (8.0 + etasq)));
			satrec.nevalues.cc1 = satrec.bstar * cc2;
			cc3 = 0.0;
			if (satrec.ecco > 1.0e-4)
				cc3 = -2.0 * coef * tsi * j3oj2 * satrec.no * sinio / satrec.ecco;
			satrec.nevalues.x1mth2 = 1.0 - cosio2;
			satrec.nevalues.cc4 = 2.0 * satrec.no * coef1 * ao * omeosq
					* (satrec.nevalues.eta * (2.0 + 0.5 * etasq) + satrec.ecco * (0.5 + 2.0 * etasq)
							- j2 * tsi / (ao * psisq)
									* (-3.0 * satrec.nevalues.con41 * (1.0 - 2.0 * eeta + etasq * (1.5 - 0.5 * eeta))
											+ 0.75 * satrec.nevalues.x1mth2 * (2.0 * etasq - eeta * (1.0 + etasq))
			...
			satrec.nevalues.mdot = satrec.no + 0.5 * temp1 * rteosq * satrec.nevalues.con41
					+ 0.0625 * temp2 * rteosq * (13.0 - 78.0 * cosio2 + 137.0 * cosio4);
			satrec.nevalues.argpdot = -0.5 * temp1 * con42 + 0.0625 * temp2 * (7.0 - 114.0 * cosio2 + 395.0 * cosio4)
			...
			if ((2 * pi / satrec.no) >= 225.0) {
				...
				dpper(satrec.dsvalues.e3, satrec.dsvalues.ee2, satrec.dsvalues.peo, satrec.dsvalues.pgho,
						...
						satrec.dsvalues.xgh2, satrec.dsvalues.xgh3, satrec.dsvalues.xgh4, satrec.dsvalues.xh2,
						satrec.dsvalues.xh3, satrec.dsvalues.xi2, satrec.dsvalues.xi3, satrec.dsvalues.xl2,
						satrec.dsvalues.xl3, satrec.dsvalues.xl4, satrec.dsvalues.zmol, satrec.dsvalues.zmos, 1);
				...
				dsinit(cosim, emsq, satrec.argpo, s1, s2, s3, s4, s5, sinim, satrec.nevalues.t, tc,
						satrec.dsvalues.gsto, satrec.mo, satrec.nevalues.mdot, satrec.no, satrec.omegao,
						satrec.nevalues.omegadot, xpidot, z1, z3, z11, z13, z21, z23, z31, z33, satrec.ecco, eccsq);
			}
			...
			if (satrec.nevalues.isimp != 1) {
				...
				satrec.nevalues.t4cof = 0.25
						* (3.0 * satrec.nevalues.d3 + satrec.nevalues.cc1 * (12.0 * satrec.nevalues.d2 + 10.0 * cc1sq));
				satrec.nevalues.t5cof = 0.2
						* (3.0 * satrec.nevalues.d4 + 12.0 * satrec.nevalues.cc1 * satrec.nevalues.d3
								+ 6.0 * satrec.nevalues.d2 * satrec.nevalues.d2
								+ 15.0 * cc1sq * (2.0 * satrec.nevalues.d2 + cc1sq));
			}
		}
		...
		if (help == 'y') {
			...
			System.out.printf("    inputs  : \n");
			System.out.printf("%7s%15d%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "satn", satn, "yr", year, "bstar",
					satrec.bstar, "ecco", satrec.ecco, "epoch ", epoch, "argpo", satrec.argpo);
			System.out.printf("%7s%15.9f%7s%15.9f\n", "inclo", satrec.inclo, "mo", satrec.mo);
			System.out.printf(" in and out variables \n");
			System.out.printf("%7s%15.9f\n", "no", satrec.no);
			System.out.printf("    outputs  :\n");
			System.out.printf("%7s%15d%7s%15d%7s%15d%7s%15.9f\n", "init", satrec.init, "isimp", satrec.nevalues.isimp,
					"method", satrec.nevalues.method, "aycof", satrec.nevalues.aycof);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f\n", "con41", satrec.nevalues.con41, "cc1",
					satrec.nevalues.cc1, "cc4", satrec.nevalues.cc4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "cc5", satrec.nevalues.cc5, "d2",
					satrec.nevalues.d2, "d3", satrec.nevalues.d3, "d4", satrec.nevalues.d4, "delmo",
					satrec.nevalues.delmo);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f\n", "eta", satrec.nevalues.eta, "argpdot",
					satrec.nevalues.argpdot, "omgcof", satrec.nevalues.omgcof);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f\n", "sinmao", satrec.nevalues.sinmao, "t2cof",
					satrec.nevalues.t2cof, "t3cof", satrec.nevalues.t3cof);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "t4cof",
					satrec.nevalues.t4cof, "t5cof", satrec.nevalues.t5cof, "gsto", satrec.dsvalues.gsto, "x1mth2",
					satrec.nevalues.x1mth2, "x7thm1", satrec.nevalues.x7thm1, "xlcof", satrec.nevalues.xlcof);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xmcof", satrec.nevalues.xmcof, "mdot",
					satrec.nevalues.mdot, "omegacf", satrec.nevalues.omegacf, "omegadt", satrec.nevalues.omegadot);
			System.out.printf("   in and outputs from deep space satellites :\n");
			System.out.printf("%7s%15.9f%7s%15.9f\n", "t", satrec.nevalues.t, "omegao", satrec.omegao);
			System.out.printf("%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "irez", satrec.dsvalues.irez, "atime",
					satrec.dsvalues.atime, "d2201", satrec.dsvalues.d2201, "d2211", satrec.dsvalues.d2211, "d3210",
					satrec.dsvalues.d3210);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "d3222",
					satrec.dsvalues.d3222, "d4410", satrec.dsvalues.d4410, "d4422", satrec.dsvalues.d4422, "d5220",
					satrec.dsvalues.d5220, "d5232", satrec.dsvalues.d5232, "d5421", satrec.dsvalues.d5421);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "d5433", satrec.dsvalues.d5433, "dedt",
					satrec.dsvalues.dedt, "del1", satrec.dsvalues.del1, "del2", satrec.dsvalues.del2, "del3",
					satrec.dsvalues.del3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "didt", satrec.dsvalues.didt, "dmdt",
					satrec.dsvalues.dmdt, "dnodt", satrec.dsvalues.dnodt, "domdt", satrec.dsvalues.domdt, "e3",
					satrec.dsvalues.e3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "ee2", satrec.dsvalues.ee2,
					"peo", satrec.dsvalues.peo, "pgho", satrec.dsvalues.pgho, "pho", satrec.dsvalues.pho, "pinco",
					satrec.dsvalues.pinco, "plo", satrec.dsvalues.plo);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "se2", satrec.dsvalues.se2,
					"se3", satrec.dsvalues.se3, "sgh2", satrec.dsvalues.sgh2, "sgh3", satrec.dsvalues.sgh3, "sgh4",
					satrec.dsvalues.sgh4, "sh2", satrec.dsvalues.sh2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "sh3", satrec.dsvalues.sh3,
					"si2", satrec.dsvalues.si2, "si3", satrec.dsvalues.si3, "sl2", satrec.dsvalues.sl2, "sl3",
					satrec.dsvalues.sl3, "sl4", satrec.dsvalues.sl4);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xfact", satrec.dsvalues.xfact, "xgh2",
					satrec.dsvalues.xgh2, "xgh3", satrec.dsvalues.xgh3, "xgh4", satrec.dsvalues.xgh4, "xh2",
					satrec.dsvalues.xh2);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xh3", satrec.dsvalues.xh3, "xi2",
					satrec.dsvalues.xi2, "xi3", satrec.dsvalues.xi3, "xl2", satrec.dsvalues.xl2, "xl3",
					satrec.dsvalues.xl3);
			System.out.printf("%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n", "xl4", satrec.dsvalues.xl4,
					"xli", satrec.dsvalues.xli, "xlamo", satrec.dsvalues.xlamo, "xni", satrec.dsvalues.xni, "zmol",
					satrec.dsvalues.zmol, "zmos", satrec.dsvalues.zmos);
		}
	}
	...
	public Sgp4Data twoline2rv(SatElset satElset) throws ObjectDecayed {
		...
		// milliseconds
		satrec.mjdsatepoch = julianday(year, calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DAY_OF_MONTH), hrs,
				min, dsecs);
	 ...
	 * @return Sgp4Data
	 */
	public Sgp4Data twoline2rv(String card1, String card2) throws SatElsetException, ObjectDecayed {
